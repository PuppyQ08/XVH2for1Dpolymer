...
def harmFreq_per_k(FC2kspace):
    ...
    for kidx in range(len(FC2kspace)):
        eigval,eigvector,D0 = eachkfreq(kidx,FC2kspace,FC2origin.copy())
        for i in range(P):
...
markk = [3,4,11,2]
#for ki in range(201):
#    diff = w_omgkpcm[ki][2] - w_omgkpcm[ki][1]
#    print(ki,"jjj ",diff)
